...
const PrintLayout = ({ bookingData }) => (
  ...
  >
    <Box sx={{ maxWidth: 500, mx: 'auto', p: 2, textAlign: 'center' }}>
      ...
      <Box sx={{ mb: 2 }}>
        <Typography variant="h5" sx={{ fontWeight: 'bold', color: '#495E57', mb: 0.5 }}>
          Booking Confirmed!
        </Typography>
      ...
      <Box sx={{
        ...
        {[
          ...
          { icon: <People />, label: "Guests", value: `${bookingData.guests} ${bookingData.guests === 1 ? 'Guest' : 'Guests'}` },
          { icon: <Celebration />, label: "Occasion", value: bookingData.occasion },
        ].map((detail, index) => (
          <Box
            key={detail.label}
            sx={{
      ...
      <Box sx={{
        ...
        <Typography variant="body2" sx={{ color: '#495E57', fontWeight: 600, mb: 0.5, fontSize: '0.9rem' }}>
...
function ConfirmedBooking() {
  ...
  const handleSocialShare = (platform) => {
    ...
    switch (platform) {
      ...
      case 'WhatsApp':
        ...
        break;
      case 'Email':
        url = `mailto:?subject=My Little Lemon Reservation&body=${encodeURIComponent(shareText + '\n\n' + shareUrl)}`;
        break;
      default:
        return;
    }
  ...
  const bookingDetails = [
    { icon: <Schedule />, label: "Date", value: formattedBookingData.date || "Not Provided" },
    { icon: <Restaurant />, label: "Time", value: formattedBookingData.time || "Not Provided" },
    { icon: <People />, label: "Guests", value: formattedBookingData.guests ? `${formattedBookingData.guests} ${formattedBookingData.guests === 1 ? 'Guest' : 'Guests'}` : "Not Provided" },
    { icon: <Celebration />, label: "Occasion", value: formattedBookingData.occasion || "Not Specified" },
  ];
      ...
      >
                ...
                <Zoom in={animationStep >= 1} timeout={800}>
                  <Avatar
                    sx={{
                      ...
                      '@keyframes pulse': {
                        '0%': { transform: 'scale(1)', boxShadow: '0 8px 24px rgba(76, 175, 80, 0.3)' },
                        '50%': { transform: 'scale(1.05)', boxShadow: '0 12px 32px rgba(76, 175, 80, 0.4)' },
                        '100%': { transform: 'scale(1)', boxShadow: '0 8px 24px rgba(76, 175, 80, 0.3)' },
                      },
                    }}
                  >
                    <CheckCircle sx={{ fontSize: { xs: 30, md: 40 }, color: 'white' }} />
                  </Avatar>
                </Zoom>
              </Box>

              <CardContent sx={{ textAlign: 'center', px: { xs: 2, md: 4 }, pb: { xs: 2, md: 4 } }}>
                {/* Main Heading */}
                  ...
                  <Box>
                    ...
                    >
                      <Button
                        ...
                        startIcon={<Home sx={{ fontSize: { xs: 18, md: 20 } }} />}
                        sx={{
                          backgroundColor: '#495E57',
                          color: '#F4CE14',
                          fontWeight: 'bold',
                      ...
                      <Box sx={{ display: 'flex', gap: { xs: 1.5, md: 2 } }}>
                        <Button
                          variant="outlined"
                          onClick={handleShare}
                          startIcon={<Share sx={{ fontSize: { xs: 16, md: 18 } }} />}
                          sx={{
                            borderColor: '#495E57',
                            color: '#495E57',
                            fontWeight: 'bold',
        ...
        >
          <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 2 }}>
            <Typography variant="h6" sx={{ fontWeight: 'bold', color: '#495E57' }}>
