...
const StoryContainer = styled(Box)(({ theme }) => ({
  ...
  "&::before": {
    ...
    height: "60%",
    background:
      "radial-gradient(ellipse, rgba(244, 206, 20, 0.03) 0%, transparent 70%)",
    borderRadius: "50%",
    zIndex: -1,
  },
  "&::after": {
    ...
    height: "80%",
    background:
      "radial-gradient(ellipse, rgba(68, 68, 85, 0.02) 0%, transparent 70%)",
    borderRadius: "50%",
    zIndex: -1,
  },
}));
...
const ParagraphText = styled(Typography)(({ theme }) => ({
  ...
  "&:nth-of-type(2)": {
    ...
    padding: "1.5rem 2rem",
    background:
      "linear-gradient(135deg, rgba(244, 206, 20, 0.04) 0%, rgba(244, 206, 20, 0.08) 100%)",
    borderRadius: "16px",
...
const FloatingAccent = styled(Box)(({ theme }) => ({
  ...
  height: "120px",
  background:
    "radial-gradient(circle, rgba(244, 206, 20, 0.1) 0%, transparent 70%)",
  borderRadius: "50%",
          ...
          <ContentSection>
            <Grid container spacing={4} alignItems="stretch">
              <Grid item xs={12} md={6}>
                <TextContent>
                  <ParagraphText>
                    Nestled in the heart of Chicago's West Loop, Little Lemon
                    was born from a dream of two brothers, Mario and Adrian, who
                    wanted to bring a slice of the Mediterranean to the Windy
                    City.
                  </ParagraphText>

                  <ParagraphText>
                    From humble beginnings as a cozy corner café, Little Lemon
                    grew into a vibrant restaurant known for its fresh
                    unforgettable flavors.
                  </ParagraphText>

                  <ParagraphText>
                    Whether you're here for a family dinner or a casual lunch,
                    we serve tradition on every plate.
                  </ParagraphText>

                  <FinalQuote>
                    <QuoteText>
                      Come taste the sunshine of the Mediterranean — right here
                      in Chicago.
                    </QuoteText>
                  </FinalQuote>
                </TextContent>
